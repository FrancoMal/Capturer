# 📸 Capturer v2.0 - Documentación para Claude

## 🎯 Propósito del Proyecto

**Capturer v2.0** es una aplicación de escritorio .NET 8 para Windows diseñada específicamente como **sistema de monitoreo de oficina 24/7**. Su función principal es capturar automáticamente pantallas de trabajo y generar reportes organizados por email.
...
#### Email Automático (Rutinario) - ✨ MEJORADO v2.1:
```csharp  
...
### 🆕 Sistema Unificado de Filtros + Cuadrantes (v2.1):
...
### 3. QuadrantService (★ Característica v2.0)
...
│   └── 2024-09\
├── Quadrants\                      ← ★ Cuadrantes procesados (v2.0)
...
Este proyecto está **bien estructurado** para ser un sistema de monitoreo empresarial robusto. La arquitectura de servicios con DI permite fácil testing y extensión. El sistema de cuadrantes v2.0 añade valor significativo para casos de uso enterprise.
