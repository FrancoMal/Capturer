...
namespace Capturer
{
    internal static class Program
    {
        ...
        private static ServiceProvider ConfigureServices()
        {
            ...
            // Register Dashboard invitation service
            services.AddSingleton<IDashboardInvitationService, DashboardInvitationService>();
            
            // Register HttpClient for dashboard communication
            services.AddHttpClient<IDashboardInvitationService>();
